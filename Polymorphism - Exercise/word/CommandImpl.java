...
public class CommandImpl implements CommandInterface {
    ...
    class CutCommand implements TextTransform{
		@Override
		public void invokeOn(StringBuilder text, int startIndex, int endIndex) {
			movedPart = text.substring(startIndex,  endIndex);
			text.delete(startIndex, endIndex);
		}
    }

    class PasteCommand implements TextTransform{
		@Override
		public void invokeOn(StringBuilder text, int startIndex, int endIndex) {
			text.replace(startIndex, endIndex, movedPart);
		}
    }
    ...
    protected List<Command> initCommands() {
        ...
        commands.add(new Command("cut", new CutCommand()));
        commands.add(new Command("paste", new PasteCommand()));
